...
<body>
    ...
    <div id="registerDerecha">
        <form action="" method="POST">
            ...
            <input id="nameEmpresa" type="text" placeholder="Ingrese el Nombre de su Empresa">
            ...
            <label for="direccionNumEmpresa">Numero:</label>
            ...
            <button id="" type="submit">Registrarse</button>
